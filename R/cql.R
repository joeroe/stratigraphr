...
#'
#' @return `character`. A CQL script.
#' @export
cql <- function(...) {
  cql <- paste(..., sep = "\n")
  cql <- paste0("! CQL2, generated by stratigraphr v",
                packageVersion("stratigraphr"),
                "\n",
                cql)
...
#' @rdname cql
#' @export
cql_boundary <- function() { warning("CQL command Boundary is not yet implemented in stratigraphr") }
...
#' @rdname cql
#' @export
cql_phase <- function() { warning("CQL command Phase is not yet implemented in stratigraphr") }
...
#' @rdname cql
#' @export
cql_sequence <- function() { warning("CQL command Sequence is not yet implemented in stratigraphr") }
